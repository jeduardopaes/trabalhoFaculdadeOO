	...
	public void primeiroMenu(){
		...
		do{
			...
			if(escolha == 1){
				...
				System.out.println("Você tem "+agenda.numeroDeContatos()+" Contatos.");
			}else if(escolha == 2){
				String nome = this.perguntaParaUsuario("Digite o Primeiro ou Ultimo do Contato:");
				this.menuDeBusca(agenda.buscarPorNome(nome));
			}else if(escolha == 3){
				agenda.organizaContatos();
				String lista = "=====Lista de Contatos=====";
				lista += agenda.toString();
				lista +="\n===========================\nExistem "+agenda.numeroDeContatos()+" Contatos.";
